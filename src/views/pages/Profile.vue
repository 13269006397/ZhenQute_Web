    ...
    <div id="profile-page">
        ...
        <div class="profile-header">
            <div class="relative">
                ...
                <div class="profile-img-container pointer-events-none">
                    <div>
                        <vs-avatar class="user-profile-img" :src=loginInfo.avatar size="85px" />
                    </div>
                ...
                <div :class="isNavOpen ? 'block': 'hidden'" class="w-full flex-grow sm:flex sm:items-center sm:w-auto">
                    <div class="text-sm sm:flex-grow">
                        <ul class="sm:flex justify-around mt-8 w-full md:mt-0 md:ml-auto md:w-3/4">
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">时间线</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">关于</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">照片</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">朋友圈</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">视频</router-link></li>
                            <li class="p-2 sm:p-0"><router-link to="/pages/profile">社交</router-link></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="vx-row">
            ...
            <div class="vx-col w-full lg:w-1/4">
                <!-- ABOUT CARD -->
                <vx-card title="个人简介" class="mt-base">
                    <!-- ACTION SLOT -->
                    ...
                    <!-- 爱好 -->
                    <div class="user-bio">
                        <p>我喜欢丽芝士，我喜欢燕荔枝和龙眼。火龙果我爱西瓜。顶级蛋糕威化饼。</p>
                    </div>
